...
<header class="wrapper">
    <nav class="nav_container">
        ...
        <ul class="nav_links">
            <li class="nav_item">
                <a href="index.php" class="nav_link home">Home</a>
            </li>
           
            <li class="nav_item">
                <a href="public/contact.php" class="nav_link">Recently Contact</a>
            </li>
            <li class="nav_item">
                <a href="public/login.php" class="nav_link Login_boton">Login</a>
            </li>
        </ul>
    </nav>
    </div>
