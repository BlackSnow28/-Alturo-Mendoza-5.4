...
<header class="wrapper">
    <nav class="nav_container">
        ...
        <ul class="nav_links">
            <li class="nav_item">
                <a href="addufos.php" class="nav_link add">Add</a>
            </li>
            <li class="nav_item">
...
<div class="content">
    ...
    <div class="newcontact">
        ...
        <form action="add.php" method="post">
            <input type="text" name="ufoWatcher" placeholder="enter your name"><br>
            <input type="text" name="ufoLocation" placeholder="enter the ufo location"> <br>
            <input type="text" name="ufoAspect" placeholder="enter ufo aspect description"><br>
